...
const Item: FC<ItemProps> & {
  ...
  <li
    className={`md:min-w-[156px] h-full rounded-md dark:duration-0 text-text-gray dark:text-white hover:bg-white-2 dark:hover:bg-gray-3 duration-150 ${className}`}
  >
    {children}
  </li>
)
