  ...
  return (
    <div className="flex flex-1 flex-col gap-2 relative">
      <Select
        ...
        className={`h-10 rounded-md appearance-none bg-no-repeat bg-right pl-5 py-2 pr-10 cursor-pointer border dark:border-gray-2`}
      >
      ...
      <button className="pointer-events-none absolute top-0 right-0 pr-5 h-[40px] flex items-center">
        <IconWrapper
          icon={<BottomArrow className="w-7 h-7" />}
          className="!w-7"
